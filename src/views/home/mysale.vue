<template>
	<div>
		<div class="navbartitle">
			<!-- <uni-nav-bar leftIcon="back" @clickLeft="back" left-text="交易所" :border="false" statusBar="true" backgroundColor="transparent" color="#fff" :leftWidth="90" ></uni-nav-bar> -->
  ...
  @click-left="onClickLeft"/>
		...
		<div class="namebuy" style="text-align: center;font-weight: 600;">
			<span style="font-size: 15px;">我要卖出</span>
		</div>
		<div class="applycardall">
			<div class="formitem">
				<span class="formname">商家名称</span>
				<div class="inputbox">
					<input type="span" v-model="formData.name" placeholder="同城花点金融" placeholder-style="color:#7889A6;font-size:13px" disabled="true"> 
				</div>
			</div>
			<div class="formitem">
				<span class="formname">代币名称</span>
				<div class="inputbox flex2">
					<input type="span" v-model="formData.coin_name" placeholder="请输入货币名称" placeholder-style="color:#C8C8C8;font-size:13px" disabled="true"> 
			...
			<div class="formitem">
				...
				<div class="inputbox">
					<input type="text" v-model="formData.contact" placeholder="数字货币交易" placeholder-style="color:#7889A6;font-size:26px" disabled="true"> 
				</div>
			</div>
			<div class="formitem">
				<span class="formname">限额</span>
				<div class="inputbox flex2">
					<input v-model="formData.low_price " placeholder="请输入最低金额" placeholder-style="color:#C8C8C8;font-size:26px" type="number"> 
					<span style="color: #7889A6;font-size: 10px;">——</span>
					<input v-model="formData.high_price" placeholder="请输入最高金额" placeholder-style="color:#C8C8C8;font-size:26px" type="number" style="padding-left: 30px;"> 
				</div>
			</div>
