<template>
  ...
  @click-left="onClickLeft"/>
		...
		<div style="text-align: center;padding: 13px 0;font-weight: 600;padding-top: 30px;">
			<span style="font-size: 16px;">申请商家</span>
		</div>
		...
		<div class="listnone" v-if="status=='refuse'">
			...
			<div style="padding-top: 24px;"><span>您提交的【{{formData.merchant_name}}】<p style="color: rgba(240, 38, 69, 1);display: inline-block;">未通过审核</p></span></div>
