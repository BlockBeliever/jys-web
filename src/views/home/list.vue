          ...
          <div class="flex2 nametime">
            <div class="flex1">
              <div class="headimgbox" v-if="merchantid !== item.user_id">
                <img v-if="item.user_head === '' && !item.base64user_head" src="../../../static/img/head.png" alt="" srcset="" />
                <img :src="item.base64user_head.startsWith('data:') || item.base64user_head.startsWith('https:') ? item.base64user_head : $IMGURL + item.base64user_head" alt="" v-if="item.base64user_head" />
              </div>
              <div class="headimgbox" v-if="merchantid === item.user_id"> 
                <img v-if="item.merchant_head === '' && !item.base64merchant_head" src="../../../static/img/head.png" alt="" srcset="" />
                <img :src="item.base64merchant_head.startsWith('data:') || item.base64merchant_head.startsWith('https:') ? item.base64merchant_head : $IMGURL + item.base64merchant_head" alt="" v-if="item.base64merchant_head" />
              </div>
    ...
    getList() {
      ...
      this.$api.orderList(this.filters).then(res => {
        ...
        data.forEach(item => {
          ...
          item.base64merchant_head = '';
          _this.list.push(item)
        })
        urlToBase64OfList(data, 'user_head');
        urlToBase64OfList(data, 'merchant_head');
