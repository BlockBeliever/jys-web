<template>
  <div class="container">
    ...
    <div class="appael">
      ...
      <van-field class="textarea" v-model="message" label-align="top" type="textarea" name="" label=""
          placeholder="请输入申诉说明" autosize maxlength="200" show-word-limit />
    </div>
    <div class="upload">
      <div class="title">上传申诉截图:</div>
      <div class="uploader">
    ...
    <div class="btn-box">
      <div class="btn2" @click="confirmClick">提交申诉</div>
      <div class="cancel" @click="cancelClick">取消申诉</div>
    </div>
  </div>
</template>
