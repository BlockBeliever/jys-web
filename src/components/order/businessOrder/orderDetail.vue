<template>
  <div class="container">
    ...
    <div v-if="detail.dispute_symbol === 1">
      ...
      <div v-if="[4, 5].includes(detail.order_status)" class="status">待确认</div>
    ...
    <div class="order">
      <div class="top">
        ...
        <span>{{ detail.goods_type === 1 ? '买入' : '出售' }}{{ detail.goods_coin }}</span>
      </div>
      <section>
        <div class="item">
      ...
      <div class="btn-box" v-if="detail.order_type === 1">
        <div v-if="detail.order_status === 4" class="botton" @click="handlePayMent">授权</div>
      </div>
      <div v-else class="btn-box">
        <div v-if="detail.order_status === 4 && detail.goods_type === 2 && detail.dispute_symbol !== 2" class="botton"
          @click="handlePayMent">授权</div>
        <div v-if="detail.order_status === 4 && detail.goods_type === 1 && detail.dispute_symbol !== 2" class="botton"
          @click="uploadClick">上传支付截图
        </div>
        <div v-if="detail.order_status === 5 && detail.dispute_symbol !== 2" class="botton" @click="sureOrder">确认订单
        </div>
        <div class="cancel"
...
import { orderDetail, refreshOrder, confirmOrder, appealCancel } from "@/api/order";
